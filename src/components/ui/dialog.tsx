  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "bottom-0 left-0 right-0 top-auto translate-x-0 translate-y-0 rounded-t-xl p-6 max-h-[92dvh] overflow-y-auto " +
        "sm:bottom-auto sm:left-[50%] sm:top-[50%] sm:translate-x-[-50%] sm:translate-y-[-50%] sm:max-w-lg sm:rounded-lg sm:max-h-[90vh]",
        className
      )}
      {...props}
    >
